...
class PrivaciesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create privacy" do
    assert_difference("Privacy.count") do
      post privacies_url, params: { privacy: { name: @privacy.name, slug: @privacy.slug, user_id: @privacy.user_id } }
    end
  ...
  test "should update privacy" do
    patch privacy_url(@privacy), params: { privacy: { name: @privacy.name, slug: @privacy.slug, user_id: @privacy.user_id } }
