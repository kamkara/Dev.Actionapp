...
class CulturesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create culture" do
    assert_difference("Culture.count") do
      post cultures_url, params: { culture: { name: @culture.name, slug: @culture.slug, user_id: @culture.user_id } }
    end
  ...
  test "should update culture" do
    patch culture_url(@culture), params: { culture: { name: @culture.name, slug: @culture.slug, user_id: @culture.user_id } }
