...
class ChartsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create chart" do
    assert_difference("Chart.count") do
      post charts_url, params: { chart: { name: @chart.name, slug: @chart.slug, user_id: @chart.user_id } }
    end
  ...
  test "should update chart" do
    patch chart_url(@chart), params: { chart: { name: @chart.name, slug: @chart.slug, user_id: @chart.user_id } }
