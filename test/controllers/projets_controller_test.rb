...
class ProjetsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create projet" do
    assert_difference("Projet.count") do
      post projets_url, params: { projet: { amount: @projet.amount, heroImg: @projet.heroImg, published: @projet.published, slug: @projet.slug, status: @projet.status, title: @projet.title, user_id: @projet.user_id } }
    end
  ...
  test "should update projet" do
    patch projet_url(@projet), params: { projet: { amount: @projet.amount, heroImg: @projet.heroImg, published: @projet.published, slug: @projet.slug, status: @projet.status, title: @projet.title, user_id: @projet.user_id } }
