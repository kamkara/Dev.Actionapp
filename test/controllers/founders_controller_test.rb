...
class FoundersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create founder" do
    assert_difference("Founder.count") do
      post founders_url, params: { founder: { slug: @founder.slug, title: @founder.title, user_id: @founder.user_id } }
    end
  ...
  test "should update founder" do
    patch founder_url(@founder), params: { founder: { slug: @founder.slug, title: @founder.title, user_id: @founder.user_id } }
