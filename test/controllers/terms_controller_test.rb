...
class TermsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create term" do
    assert_difference("Term.count") do
      post terms_url, params: { term: { name: @term.name, slug: @term.slug, user_id: @term.user_id } }
    end
  ...
  test "should update term" do
    patch term_url(@term), params: { term: { name: @term.name, slug: @term.slug, user_id: @term.user_id } }
